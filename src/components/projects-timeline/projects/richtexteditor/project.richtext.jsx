...
import RichTextEditor from "../../../../assets/img/projects/richtext.png";
...
export const Richtexteditor = () => {
    return(
        <>
            <ImageEvent 
                date={i18n.t('projects.apps.richtext.date')} 
            ...
            >
                <div className="d-flex justify-content-between flex-column mt-1">
                            ...
                            <Card>
                                ...
                                <Accordion.Collapse eventKey="0" className="text-left">
                                    <Card.Body>
                                        ...
                                        <ul className=" pt-1">
                                            <li>{i18n.t('projects.apps.richtext.firstline')}</li>
                                            <li>{i18n.t('projects.apps.richtext.secondline')}</li>
                                            <li>{i18n.t('projects.apps.richtext.thirtline')}</li>
                                        </ul>
                                        <hr />
                    ...
                    <div className="d-flex justify-content-between flex-nowrap text-center">
                        <UrlButton href="https://github.com/trpiano/RichTextEditor" target="_blank">
                            {i18n.t('projects.titles.source')}
                        </UrlButton>
                        <UrlButton href="https://rich-text-editor-ffdjdb1nl-trpiano.vercel.app" target="_blank">
